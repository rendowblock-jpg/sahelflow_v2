...
describe("production licensing authority inventory", () => {
  ...
  it("version-binds the Founder offline checkpoint while customer releases still fail closed", () => {
    ...
    expect(versionAuthority).toContain('\"version\": \"1.0.0-internal.25\"');
    expect(versionAuthority).toContain('\"releaseMode\": \"founder-offline-only\"');
    expect(versionAuthority).toContain('\"authorityDecision\": \"FD-044\"');
    expect(versionAuthority).toContain('\"ownedHostSuffix\": null');
    expect(versionAudit).toContain("founder-offline-only licensing is authorized only for Internal.15/FD-032, Internal.16/FD-034, Internal.17/FD-036, Internal.18/FD-037, Internal.19/FD-038, Internal.20/FD-039, Internal.21/FD-040, Internal.22/FD-041, Internal.23/FD-042, Internal.24/FD-043, or Internal.25/FD-044");
    ...
    expect(build).toContain('Some(\"1.0.0-internal.19\"), Some(\"FD-038\")');
    expect(build).toContain('Some(\"1.0.0-internal.20\"), Some(\"FD-039\")');
    expect(build).toContain('Some(\"1.0.0-internal.21\"), Some(\"FD-040\")');
    expect(build).toContain('Some(\"1.0.0-internal.22\"), Some(\"FD-041\")');
    expect(build).toContain('Some(\"1.0.0-internal.23\"), Some(\"FD-042\")');
    expect(build).toContain('Some(\"1.0.0-internal.24\"), Some(\"FD-043\")');
    expect(build).toContain('Some(\"1.0.0-internal.25\"), Some(\"FD-044\")');
    expect(build).toContain("founder-offline-only licensing is authorized only for exact FD-032/Internal.15, FD-034/Internal.16, FD-036/Internal.17, FD-037/Internal.18, FD-038/Internal.19, FD-039/Internal.20, FD-040/Internal.21, FD-041/Internal.22, FD-042/Internal.23, FD-043/Internal.24, or FD-044/Internal.25");
    ...
    expect(release).toContain("exact FD-032/Internal.15, FD-034/Internal.16, FD-036/Internal.17, FD-037/Internal.18, FD-038/Internal.19, FD-039/Internal.20, FD-040/Internal.21, FD-041/Internal.22, FD-042/Internal.23, FD-043/Internal.24, or FD-044/Internal.25");
