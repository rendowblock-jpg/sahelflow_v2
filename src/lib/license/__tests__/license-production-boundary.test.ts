...
describe("production licensing authority inventory", () => {
  ...
  it("version-binds the Founder offline checkpoint while customer releases still fail closed", () => {
    ...
    expect(build).toContain('Some(\"1.0.0-internal.26\"), Some(\"FD-046\")');
    expect(build).toContain('Some(\"1.0.0-internal.27\"), Some(\"FD-047\")');
    expect(build).toContain('Some(\"1.0.0-internal.28\"), Some(\"FD-049\")');
    expect(build).toContain("founder-offline-only licensing is authorized only for exact FD-032/Internal.15, FD-034/Internal.16, FD-036/Internal.17, FD-037/Internal.18, FD-038/Internal.19, FD-039/Internal.20, FD-040/Internal.21, FD-041/Internal.22, FD-042/Internal.23, FD-043/Internal.24, FD-044/Internal.25, FD-046/Internal.26, FD-047/Internal.27, FD-049/Internal.28, FD-050/Internal.29, FD-051/Internal.30, FD-053/Internal.31, FD-055/Internal.32, FD-056/Internal.33, FD-057/Internal.34, or FD-058/Internal.35");
