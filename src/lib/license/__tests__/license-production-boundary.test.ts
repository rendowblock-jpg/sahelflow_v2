...
describe("production licensing authority inventory", () => {
  ...
  it("version-binds the Founder offline checkpoint while customer releases still fail closed", () => {
    ...
    expect(versionAuthority).toContain('\"version\": \"1.0.0-internal.22\"');
    expect(versionAuthority).toContain('\"releaseMode\": \"founder-offline-only\"');
    expect(versionAuthority).toContain('\"authorityDecision\": \"FD-041\"');
    expect(versionAuthority).toContain('\"ownedHostSuffix\": null');
    expect(versionAudit).toContain("founder-offline-only licensing is authorized only for Internal.15/FD-032, Internal.16/FD-034, Internal.17/FD-036, Internal.18/FD-037, Internal.19/FD-038, Internal.20/FD-039, Internal.21/FD-040, or Internal.22/FD-041");
    ...
    expect(build).toContain("founder-offline-only licensing is authorized only for exact FD-032/Internal.15, FD-034/Internal.16, FD-036/Internal.17, FD-037/Internal.18, FD-038/Internal.19, FD-039/Internal.20, FD-040/Internal.21, or FD-041/Internal.22");
    ...
    expect(release).toContain("exact FD-032/Internal.15, FD-034/Internal.16, FD-036/Internal.17, FD-037/Internal.18, FD-038/Internal.19, FD-039/Internal.20, FD-040/Internal.21, or FD-041/Internal.22");
