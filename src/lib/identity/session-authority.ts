 ...
 *
 * `setup` is deliberately distinct from authentication. A session is accepted
 * only while its signature, database row, revocation state, overall age and
 * seller-activity window are all current.
 */
