...
export const GET = withErrorHandler(async (req: NextRequest) => {
  ...
  await logAudit({ prisma: db, shop: shopContext }, { action: "export.expenses", entity: "expenses", actor: trustedActorAuditIdentity(actorContext.actor), after: { format: req.nextUrl.searchParams.get("format") ?? "csv" } });
