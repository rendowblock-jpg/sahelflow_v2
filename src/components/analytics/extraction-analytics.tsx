...
export function ExtractionAnalytics() {
      ...
      <div className="app-content page-sections">
        <Card>
          <CardContent className="py-12 text-center text-muted-foreground">
            No extraction data yet. AI-powered order extractions will appear here.
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="app-content page-sections">
      <h1 className="text-2xl font-bold tracking-tight mb-6">AI Extraction Analytics</h1>
            ...
            {data.byMethod.map((m) => (
              <div key={m.method} className="flex items-center justify-between">
                ...
                <div className="flex gap-4 text-sm text-muted-foreground">
                  ...
                  <span>{(m.avgConfidence * 100).toFixed(0)}% avg confidence</span>
      ...
      {data.trend.length > 0 && (
        <Card>
          <CardHeader><CardTitle>Daily Trend (30 days)</CardTitle></CardHeader>
          <CardContent>
