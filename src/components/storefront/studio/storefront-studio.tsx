  ...
  return (
    ...
    >
      <header className="flex min-h-14 flex-wrap items-center gap-2 border-b bg-background px-3 py-2">
        ...
        <label className="inline-flex min-h-9 items-center gap-2 rounded-lg border px-2.5 text-caption font-medium">
          <input
            type="checkbox"
          ...
          >
            {PANELS.map((item) => (
              <button
                ...
                className={cn(
                  "min-h-9 rounded-lg px-2 text-start text-caption font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-ring",
                  panel === item.id
...
function SeoPanel({
  ...
  return (
    <div className="space-y-3">
      ...
      />
      <div className="rounded-lg border p-2 text-caption leading-4 text-muted-foreground">
