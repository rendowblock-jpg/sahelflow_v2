...
const STATUS_STYLES: Record<string, { i18nKey: string; dot: string; bg: string; text: string; border: string }> = {
  ...
  out_for_delivery: { i18nKey: "deliveries.status.outForDelivery", dot: "bg-sky-500", bg: "bg-sky-50 dark:bg-blue-950/40", text: "text-sky-700 dark:text-blue-400", border: "border-blue-200 dark:border-blue-800/50" },
