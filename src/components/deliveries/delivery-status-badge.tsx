...
const STATUS_STYLES: Record<string, { i18nKey: string; dot: string; bg: string; text: string; border: string }> = {
  pending: { i18nKey: "deliveries.status.pending", dot: "bg-warning", bg: "bg-amber-50 dark:bg-amber-950/40", text: "text-warning dark:text-amber-400", border: "border-amber-200 dark:border-amber-800/50" },
  created: { i18nKey: "deliveries.status.created", dot: "bg-teal-500", bg: "bg-teal-50 dark:bg-teal-950/40", text: "text-teal-700 dark:text-teal-400", border: "border-teal-200 dark:border-teal-800/50" },
  picked_up: { i18nKey: "deliveries.status.pickedUp", dot: "bg-teal-500", bg: "bg-teal-50 dark:bg-teal-950/40", text: "text-teal-700 dark:text-teal-400", border: "border-teal-200 dark:border-teal-800/50" },
  ...
  out_for_delivery: { i18nKey: "deliveries.status.outForDelivery", dot: "bg-teal-500", bg: "bg-teal-50 dark:bg-teal-950/40", text: "text-teal-700 dark:text-teal-400", border: "border-teal-200 dark:border-teal-800/50" },
  delivered: { i18nKey: "deliveries.status.delivered", dot: "bg-success", bg: "bg-emerald-50 dark:bg-emerald-950/40", text: "text-success dark:text-emerald-400", border: "border-emerald-200 dark:border-emerald-800/50" },
  returned: { i18nKey: "deliveries.status.returned", dot: "bg-destructive", bg: "bg-red-50 dark:bg-red-950/40", text: "text-destructive dark:text-red-400", border: "border-red-200 dark:border-red-800/50" },
  ...
  failed: { i18nKey: "deliveries.status.failed", dot: "bg-destructive", bg: "bg-red-50 dark:bg-red-950/40", text: "text-destructive dark:text-red-400", border: "border-red-200 dark:border-red-800/50" },
};
