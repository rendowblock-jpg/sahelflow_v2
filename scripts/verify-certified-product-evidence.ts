...
const allowedImmediatePaths = new Set([
  ".github/release-requests/internal-22-founder-aaa-experience.json",
...
if (requestName !== "internal-22-founder-aaa-experience.json") {
  throw new Error(`Internal.22 certified-parent reuse must use internal-22-founder-aaa-experience.json, found ${requestName}`);
}
