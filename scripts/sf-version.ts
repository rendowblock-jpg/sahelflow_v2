...
const founderOfflineCheckpoint =
  ...
  ((authority.version === "1.0.0-internal.15" && authority.licensing?.authorityDecision === "FD-032") ||
    ...
    (authority.version === "1.0.0-internal.20" && authority.licensing?.authorityDecision === "FD-039") ||
    (authority.version === "1.0.0-internal.21" && authority.licensing?.authorityDecision === "FD-040") ||
    (authority.version === "1.0.0-internal.22" && authority.licensing?.authorityDecision === "FD-041") ||
    (authority.version === "1.0.0-internal.23" && authority.licensing?.authorityDecision === "FD-042") ||
    ...
    (authority.version === "1.0.0-internal.29" && authority.licensing?.authorityDecision === "FD-050") ||
    (authority.version === "1.0.0-internal.30" && authority.licensing?.authorityDecision === "FD-051") ||
    (authority.version === "1.0.0-internal.31" && authority.licensing?.authorityDecision === "FD-053") ||
    (authority.version === "1.0.0-internal.32" && authority.licensing?.authorityDecision === "FD-055") ||
