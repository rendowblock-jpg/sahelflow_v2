            ...
            let exact_checkpoint = authority.get("channel").and_then(serde_json::Value::as_str)
                ...
                && matches!(
                    ...
                    (Some("1.0.0-internal.15"), Some("FD-032"))
                        ...
                        | (Some("1.0.0-internal.20"), Some("FD-039"))
                        | (Some("1.0.0-internal.21"), Some("FD-040"))
                        | (Some("1.0.0-internal.22"), Some("FD-041"))
                        | (Some("1.0.0-internal.23"), Some("FD-042"))
                        | (Some("1.0.0-internal.24"), Some("FD-043"))
                        | (Some("1.0.0-internal.25"), Some("FD-044"))
                        | (Some("1.0.0-internal.26"), Some("FD-046"))
                        | (Some("1.0.0-internal.27"), Some("FD-047"))
                        | (Some("1.0.0-internal.28"), Some("FD-049"))
                        | (Some("1.0.0-internal.29"), Some("FD-050"))
                        | (Some("1.0.0-internal.30"), Some("FD-051"))
                        | (Some("1.0.0-internal.31"), Some("FD-053"))
                        | (Some("1.0.0-internal.32"), Some("FD-055"))
                        | (Some("1.0.0-internal.33"), Some("FD-056"))
                        | (Some("1.0.0-internal.34"), Some("FD-057"))
                        | (Some("1.0.0-internal.35"), Some("FD-058"))
                );
            if !exact_checkpoint {
                panic!("founder-offline-only licensing is authorized only for exact FD-032/Internal.15, FD-034/Internal.16, FD-036/Internal.17, FD-037/Internal.18, FD-038/Internal.19, FD-039/Internal.20, FD-040/Internal.21, FD-041/Internal.22, FD-042/Internal.23, FD-043/Internal.24, FD-044/Internal.25, FD-046/Internal.26, FD-047/Internal.27, FD-049/Internal.28, FD-050/Internal.29, FD-051/Internal.30, FD-053/Internal.31, FD-055/Internal.32, FD-056/Internal.33, FD-057/Internal.34, or FD-058/Internal.35 on the internal channel with no owned host suffix");
            }
            true
        }
