...
> **Source baseline:** protected `main` after the round-2 campaign repair line #370–#375 (B3 named sidecar rejections with `code:reason` propagation #372; R4 raw mic `DOMException.name` #370; B5 fully coded server shapes #371 + client reason surfacing #375; FD-054 demo coexist #374) on top of the FD-050 repair series #346–#353 and the deep-audit register #355
> **Signed/installed baseline:** Internal.31 / FD-053 (latest Founder-installed, 2026-09-01)
> **Latest signed/published:** Internal.31 / FD-053 (tag `sahelflow-v1.0.0-internal.31-38c95aa8f5e1f3d44326c727efd0d8fd54cba20a`, Founder-installed; packages the FD-051 repair line #362–#366 AND the #359 six-wave stream). The round-2 repairs #370–#375 ride protected `main` and are packaged in the Internal.32 successor (FD-055). Retained Internal.30 publication: tag `sahelflow-v1.0.0-internal.30-2eb8a33749118e233240019bf2df9a47d586a04d`, MSI digest `sha256:bef15026fc3f7394f2b10d15a809229418c585191509c78941a27461fbc8210e`)
...
| No-refresh live Inbox projection | implemented-unproven | PR #315 loopback CSP, WebSocket grant and polling recovery are protected source; #352 adds the C1 resilience hardening (60s guarded reconnect watchdog so sleep/wake or network blips no longer kill auto-receive permanently; status/group broadcasts scope-filtered before the durable spool); the deep-audit register (#355) replaces the remote command/projection workers' silent catches with classified failure logging and escalation after persistent failure streaks | Source and exact-head CI passed for PR #315 | Not in Internal.27; packaged in published Internal.28 | Internal.27 required manual refresh; the Founder observed automatic no-refresh arrival on the installed Internal.28 build (2026-08-28 campaign) | Internal.29 candidate: re-confirm automatic arrival after the in-place update; formal state conversion happens at campaign reconciliation |
...
| Capability | Current state | Source truth | Automated evidence | Signed / installed evidence | Live-provider evidence | Remaining gate |
|---|---|---|---|---|---|---|
| Image classification and bounded metadata | implemented-unproven | Protected main seals type, MIME, name, dimensions and declared size; unsafe declarations are rejected | #321 retained extractor/codec/integration coverage and exact-head required gates | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | None | Installed Internal.28 plus representative real image |
| Video classification and bounded metadata | implemented-unproven | Protected metadata boundary includes a 64 MiB declared-size ceiling | #321 exact-head source/native/Windows gates passed | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | None | Installed Internal.28 plus representative real video |
| Document classification and bounded metadata | implemented-unproven | Safe filename leaf, allowlisted MIME and declared-size ceiling are protected source | #321 exact-head gates passed | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | None | Installed Internal.28 plus representative real document |
| Voice/audio classification and bounded metadata | implemented-unproven | Protected duration, MIME, size and voice/PTT flag are canonical metadata | #321 exact-head gates passed | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | None | Eventual signed install plus representative voice/audio |
| Sticker classification and bounded metadata | implemented-unproven | Protected WebP metadata and 4 MiB declared-size ceiling are canonical source | #321 exact-head gates passed | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | None | Installed Internal.28 plus representative real sticker |
...
| Delivery/read receipts | certified (re-proved on installed Internal.30, 2026-08-31) | One canonical dependency-free mapper (`sidecars/whatsapp/delivery-status.ts`, #350) pinned at runtime against the installed Baileys 6.17.16 proto enum {ERROR:0,PENDING:1,SERVER_ACK:2,DELIVERY_ACK:3,READ:4,PLAYED:5}; monotonic persisted status projection retained | `delivery-status.test.ts` 7/7 incl. the runtime installed-enum cross-check | #350 packaged in published Internal.30; Founder re-proved the truthful states on a real outbound during the FD-051 installed campaign (R7, 2026-08-31): sent/delivered/read all observed through the corrected mapping | Exactly-one real outbound re-proved with the truthful mapper on the installed build | None — the prior Internal.27-undermining finding is closed by this re-proof; future campaigns re-run rows per their own scope |
...
| Image sending | implemented-unproven | Merged PR #324 owns the image picker → bounded multipart route → encrypted `.sfmedia` authority → canonical Message/outbox effect → account-bound deterministic receipt journal → Baileys image dispatch; retries authenticate local bytes before provider-effect start and preview/download stays Message-bound | Exact-head Quality, Phase 5, Phase 6–7, protected-storage Windows, database/standalone/contained launcher and ephemeral installed gates passed before guarded merge | Ephemeral installed evidence exists; Internal.28 Founder-installed — the Founder verified a real image send on the installed build (2026-08-28 campaign) | None | Internal.29 candidate: one representative real-phone image send/receipt/reopen re-exercise; formal state conversion happens at campaign reconciliation |
| Video sending | implemented-unproven | Merged PR #325 owns the MP4-only outbound video action: 64 MiB request/object ceilings, authenticated video-track metadata, positive-or-truthful-null duration (silent video-only containers), encrypted staging, canonical video Message/outbox, dedicated provider lease, deterministic account-bound sidecar receipt, guarded staged-object reclamation and Message-only local playback | Exact-head Quality/review and required gates passed before guarded merge | Internal.28 Founder-installed — the Founder verified a real video send on the installed build (2026-08-28 campaign) | None | Internal.29 candidate: one representative real-phone video send/receipt/reopen re-exercise; formal state conversion happens at campaign reconciliation |
| Document sending | implemented-unproven | Merged PR #327 owns the bounded business-document outbound action; #349 repairs FD-050 campaign row B3; #362 carries the declared MIME through the sidecar multipart; round-2 #372 names the failing rule in every document-send rejection (each 400 branch answers with its own machine-readable `reason` — recipient/caption/effect_key/request_binding/file_name/document_part/document_empty/document_too_large/document_type/form_too_large/form_unreadable) and the durable effect record composes `code:reason` into `lastErrorCode` (e.g. `INVALID_DOCUMENT_SEND_REQUEST:file_name`) so the installed UI shows WHICH rule failed; a real-sidecar probe matrix proves every realistic composer `.docx` shape (Arabic names, LID recipients, zip-declared OOXML) passes validation: PDF/Word/Excel/text/CSV declarations under the 64 MiB object ceiling, sniffed-content authentication (PDF/zip/OLE-storage/text), encrypted staging, canonical document Message/outbox, dedicated provider lease, deterministic account-bound sidecar receipt with a required safe file name, guarded staged-object reclamation and Message-bound document reads/downloads that preserve document file-name extensions. Merged #336 resolves the recipient-facing truth on top: OOXML documents are ZIP containers, so the sniffed `application/zip` receipt is resolved to the declared Office mimetype at queue time and carried by the sealed attachment, effect payload, provider dispatch and sidecar allowlist (with msword/ms-excel/text/csv), while byte authentication keeps the truthful container classification | Exact-head Quality/review and required gates passed before guarded merge; #336 adds a real PK-magic docx integration case and extends the sidecar contract tests; #372 pins reason propagation (13/13 sidecar-client tests) and adds the real-sidecar probe matrix | Internal.28 installed campaign: a real Word/Excel file arrived on the recipient phone as a generic `.zip` — root-caused and fixed by #336 on main. Installed Internal.31 (2026-09-01): a rejection still surfaced bare because the reason was discarded in the effect pipeline — repaired by #372 on main | None | Next candidate (Internal.32): Founder re-sends a real PDF and a real Word/Excel file and confirms the phone renders the document, never a .zip; any rejection now names its exact failing rule |
| Voice/PTT sending | implemented-unproven | Merged PR #329 owns the bounded outbound voice/PTT action: Opus-in-OGG audio (PTT flag only for OGG/Opus, canonical `audio/ogg; codecs=opus` MIME) under a 32 MiB request/object ceiling, `music-metadata` audio authentication that rejects non-Opus OGG and video-bearing containers with a truthful-null duration fallback, encrypted staging, canonical voice Message/outbox with no caption/file-name surface, dedicated provider lease, deterministic account-bound sidecar receipt, guarded staged-object reclamation and Message-only local playback. Merged #337 adds the in-composer recorder the file-picker button implied; #346 repairs the FD-050 B4 root (WebM/Opus take remuxed to OGG/Opus in the renderer; RFC 6716 TOC exactness via #353); #365 maps `getUserMedia` rejections to three distinct localized causes with `DOMException.name` logging; round-2 #370 surfaces the RAW `DOMException.name` inside the named-cause voice banners so an installed build records the exact browser layer that failed | Programmatic OGG/Opus/Vorbis/WAV fixture integration tests (7) plus the 6-part voice source contract, the #337 recorder boundary contract and the #370 banner copy contract among the inbox suites; exact-head required gates passed before each guarded merge | Internal.28 installed campaign: the mic button opened the audio file dialog — fixed by #337. FD-050 row B4: fail-closed unsupported strip on installed Internal.29 — repaired by #346/#353. Installed Internal.31 (2026-09-01): mic layer still failing with the cause not fully identified — the raw `DOMException.name` banner landed as #370 on main | None | Next signed successor (Internal.32): Founder records a voice note from the mic button, sends it, and confirms PTT playback on the recipient phone; re-verify file/paste audio still sends |
| Upload progress and pre-effect cancellation | implemented-unproven | Merged PR #331 owns truthful XHR byte-progress and a registered pre-response abort handle per outbound media send; the abort is honoured only while the browser request is in flight, the cancellable flag drops at 100% and no post-queue or post-commit cancellation is claimed | Upload/progress UI source contract among the 228-test WhatsApp/inbox suite; exact-head required gates passed before guarded merge | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | None | Packaged in published Internal.28; after Founder install one representative real-phone in-flight cancel observation |
| Quoted replies with visible context | implemented-unproven | Merged PR #331 owns the durable quoted-reply authority; #351 repairs FD-050 campaign rows B1/B2 on top (the single `toInboxMessageFromWhatsApp` history projection preserves quotedMessageId/quoted so chips survive chat switch, background refresh and restart): bounded provider context (stanza ID, sender identity, single-type fallback stub) resolved at queue time from canonical provenance only — inbound targets require an applied provider ingress event and outbound targets a confirmed provider message ID; foreign-conversation, system/activity and unconfirmed targets are rejected before any media staging; the quote target is bound into effect authority identity; the composer carries a conversation-scoped reply preview and the messages route resolves out-of-window quote targets (bounded to 100). Merged #335 fixes the Internal.28 installed-campaign regression on top: the #317 projection surfaces messages under provider stanza IDs (WAMIDs), so the resolver now resolves both id spaces (canonical id, applied inbound `providerEventId`, confirmed outbound `providerMessageId`; ambiguous ids only resolve inside the quoting conversation) and persists the canonical target id on `Message.quotedMessageId` so local quote previews keep resolving; route regexes widen to 96 chars for real WAMIDs | 4 quoted-reply integration tests plus composer/preview source contracts among the 228-test WhatsApp/inbox suite; #335 adds received-by-WAMID, sent-by-provider-id and cross-chat-WAMID-refusal integration cases; exact-head required gates passed before each guarded merge | Internal.28 installed campaign: quoting ANY message failed (both received and sent) because production quotes WAMIDs the old resolver never accepted — root-caused and fixed by #335 on main | None | Next candidate: Founder replies to a received message and to a sent message and confirms the quote renders on the recipient phone |
| Persisted protected drafts | implemented-unproven | Protected per-conversation draft and debounced idempotent replacement are merged source | Targeted API/UI/crypto tests | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | Not applicable | Installed Internal.28 reopen/switch observation |
...
| Explicit mark unread | implemented-unproven | Explicit unread increments only a zero count and returns to queue so background read does not erase intent | Targeted route/UI tests | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | Not applicable | Installed Internal.28 observation |
| Safe location link | implemented-unproven | Coordinates create a fixed HTTPS OpenStreetMap URL with `noopener noreferrer` | Targeted UI contract | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | Not applicable | Installed Internal.28 RTL/mobile observation |
| Safe message copy | implemented-unproven | Merged PR #331 owns an explicit per-message copy control that writes only the canonical message text through the permission-preserving clipboard path and shows an explicit failure state instead of silent success | Copy UI source contract among the 228-test WhatsApp/inbox suite; exact-head required gates passed before guarded merge | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | Not applicable | Packaged in published Internal.28; retain browser failure-state regression coverage after install |
...
| Paste/drag-drop media | implemented-unproven | Merged PR #331 routes one pasted or dropped file through the same validated encrypted staging path and ceilings as the bounded pickers, with document drops extension-screened before ingestion and no bypass of picker limits or permissions | Ingestion source contract among the 228-test WhatsApp/inbox suite; exact-head required gates passed before guarded merge | Internal.28 Founder-installed (2026-08-28 campaign); Internal.29 published pending in-place update | None | Packaged in published Internal.28; after Founder install one representative real paste/drop observation |
| Chat deletion (multi-select, permanent) | implemented-unproven | Merged PR #338 owns founder-confirmed permanent multi-select deletion; #347 repairs the FD-050 campaign row B5 root causes (ingress tombstoning; coded delete failures surfaced); #364 codes `INVALID_DELETE_REQUEST` with PII-free shape logging; #371 codes the two anonymous shape-level 400 branches (`REQUEST_VALIDATION_FAILED` / `INVALID_REQUEST_JSON`) so every 400 body carries both `code` and a readable message; round-2 client surfacing #375 carries the server's human-readable `error` text (`DeleteChatsOutcome.errorDetail`) into the confirm dialog + toast with the new `deleteChatsFailedReason` copy in en/fr/ar: new `conversations.delete` authority (owner + manager presets, deny-by-default for custom policies), `POST /api/whatsapp/chats/delete` bounded to 100 canonical ids, one transaction removing ingress attempts/events (including not-yet-applied events so queued inbound cannot resurrect the chat), outbox intents (cancelling pending sends), outbound effects and the conversation (messages cascade), best-effort post-commit removal of canonical + thumbnail `.sfmedia` objects, append-only BusinessCommand/DomainEvent audit history preserved, queue multi-select UI with select-all, selection count and a truthful confirmation dialog (WhatsApp-side copies stay on the recipient's phone), and open-chat deletion that drops the thread without persisting its draft | Chat-delete integration suite (cascade truth, survivor isolation, pending-event removal, staged-media removal, non-WhatsApp/empty guards) plus permissions tests among the WhatsApp/inbox suites; #375 pins the reason-surfacing contract (inbox contract + copy-authority suites 45/45); exact-head required gates passed before guarded merge | None | None | Internal.34 installed round (2026-09-05): the founder deleted successfully on the second attempt after a FIRST-attempt error — root named F-10 in the UI/UX triage: SQLite write-lock contention on the multi-statement deletion transaction; PR #396 adds a bounded busy-retry (two re-issues, 150/450ms; P2024/SQLITE_BUSY classes) that is retry-safe by construction (atomic tx re-asserting the same ids) while non-busy failures still surface coded | Next candidate: Founder multi-selects chats, deletes them permanently FIRST-TRY, confirms the queue/thread/refresh truth and that the recipient phone copies remain; any rejection still shows the exact server reason + code in the operator's locale |
...
| Provider diagnostics and recovery | implemented-unproven | Connection state, ingress recovery and durable effect status remain visible; the deep-audit register (#355) surfaces connect/logout failures instead of silent refusals (`res.ok` truth, localized coded errors via `translateServerError` + toast) | Integration/UI contract tests | Partial installed evidence | Failure matrix incomplete | Keep normal conversation work usable during degradation |
