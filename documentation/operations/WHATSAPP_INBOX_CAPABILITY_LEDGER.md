...
> **Source baseline:** protected `main` `b1b5a033` after the FD-050 installed-campaign repair series (#346–#353) (Internal.28 installed-campaign fixes and extensions: #335 quoted replies raised by provider message IDs, #336 OOXML document dispatch truth, #337 in-composer voice recording, #338 permanent multi-select chat deletion, #340 evidence-build browser-args drift-proofing, #339 composer compaction with a bottom-anchored history)
...
| No-refresh live Inbox projection | implemented-unproven | PR #315 loopback CSP, WebSocket grant and polling recovery are protected source; #352 adds the C1 resilience hardening (60s guarded reconnect watchdog so sleep/wake or network blips no longer kill auto-receive permanently; status/group broadcasts scope-filtered before the durable spool) | Source and exact-head CI passed for PR #315 | Not in Internal.27; packaged in published Internal.28 | Internal.27 required manual refresh; the Founder observed automatic no-refresh arrival on the installed Internal.28 build (2026-08-28 campaign) | Internal.29 candidate: re-confirm automatic arrival after the in-place update; formal state conversion happens at campaign reconciliation |
