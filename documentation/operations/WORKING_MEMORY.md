...
[**Proven Canonical Windows Desktop**](PROVEN_CANONICAL_WINDOWS_DESKTOP_WAVE.md) is active. PR #104 integrated the source checkpoint into `main` at `d33890fe31836d9a982902dd469bcc3960c4c23c`; PR #105 integrated the reproducible remote-development environment at `1a0469bb5384561d85178316d0cd6e94745b44a0`. No Codespaces result is installed-Windows evidence.
...
- PR #105 integrated the environment into `main` at `1a0469bb5384561d85178316d0cd6e94745b44a0`; final-head run `29700649624` passed the Quality Gate in 3 minutes 26 seconds and Tauri release smoke in 46 seconds.
...
1. select and separately authorize the exact Windows implementation-lab environment and internal-candidate procedure;
2. then build the internal MSI and perform the clean-install, migration, restart/crash-loop and failure-injection matrix before any installed-candidate claim.
