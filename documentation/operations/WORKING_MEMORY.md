...
- App `1.0.0-internal.34`; MSI `1.0.0.34`; authority **FD-057**; mode `founder-offline-only` (published 2026-09-05; the Founder's installed checkpoint remains Internal.33 until the next in-place update — see the top Current-truth bullet).
