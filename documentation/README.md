...
4. [`product/DECISIONS.md`](product/DECISIONS.md) — consolidated Founder decisions through FD-033; the FD-034, FD-035 **and FD-036** addenda below are authoritative until the register is next consolidated.
...
Repository `AGENTS.md` is the coding-agent entry point. Do not create a competing permanent masterplan or use archive material as current authority.
...
Internal.16 installed evidence rejected Founder Phase 5/6 visual/experience acceptance and kept #221 open. The six classes requiring fresh explicit Founder accept/reject on the signed Internal.17 installation are:

1. `SF16-UI-001` — RTL/direction geometry.
2. `SF16-THEME-015` — atomic theme switching and appearance quality.
3. `SF17-MOTION-018` — coherent motion/micro-interaction quality and reduced-motion behavior.
...
The complete historical FD-033 register remains evidence continuity; silence or absence of a new screenshot is not closure evidence.

## FD-034 — Internal.16 Founder-only offline checkpoint

> **Status:** Founder-approved and executed
> **Approved:** 2026-08-14
> **Exact scope:** `1.0.0-internal.16` / MSI `1.0.0.16` only
> **Published source:** `c8200fdd0fe212cc7493de434d19bd8e7395c4ea`
> **Signed run:** `31770292329`

FD-034 authorized Internal.16 solely as a Founder/internal-lab checkpoint using the signed permanent offline entitlement. It did not authorize customer-online trial distribution, Beta, Stable, or automatic Founder acceptance. #221, #226 and #230 remained separate obligations.

## FD-035 — Internal.16 frontend rejection and Internal.17 correction frontier

> **Status:** Historical source-correction authority; correction completed and protected
> **Approved:** 2026-08-14
> **Scope:** source-level Internal.17 correction after installed Internal.16 rejection; not release-signing authority

FD-035 authorized the bounded frontend correction that is now protected by PR #254. It did **not** itself authorize an Internal.17 signed checkpoint. Its implementation instructions are historical and must not be resumed as the current frontier.
...
FD-036 does **not** authorize customer-online distribution, Beta, Stable, or any later version. Those paths continue to fail closed until their separate owned-host/network/release authorities exist. The six Founder-rejected visual/interaction classes still require explicit Founder accept/reject on the signed Internal.17 installation.
...
A user-ready claim may not combine Founder acceptance from one build, performance evidence from another and network/licensing evidence from a third. If material source, packaging, runtime, licensing/network or user-facing behavior changes after a gate, rerun every affected gate and repeat Founder acceptance as necessary.

## Release and launch boundary

Internal.17 under FD-036 is a Founder/internal-lab checkpoint, not a customer release. Before broader user-ready/Stable claims, at minimum:

- the applicable acceptance register must have zero unresolved P0/P1 for that claim;
- #221, #226 and #230 must support one coherent signed candidate at their required evidence levels;
