...
```text
start from installed Internal.14 with the valid permanent Founder entitlement
→ record issue #221 Arabic/RTL/accessibility Founder checkpoint
→ measure the multi-minute cold start under issue #226
→ retain the post-activation blank/restart observation
→ close issue #230 only after live resilient trial certification
...
release. PR #229 is documentation-only.
...
distinct. Internal.14 is Founder-installed and permanently licensed, but not
