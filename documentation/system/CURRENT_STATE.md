...
> **Live protected main:** resolve from GitHub before every action; best-known local `origin/main` is `41f7e149…` after PR #400 (AI agents AAA command-center) on top of docs-only #399 and release-authority #398 (live fetch unreachable from this machine — re-resolve live); at the #399 reconciliation it was `f45e6e1…` after the Internal.35 release-authority PR #398 squash (FD-058; on top of #397 `d83bd8e…` and #396 `dcd82f8…`)
