...
> **Live protected main:** resolve from GitHub before every action; best-known local `origin/main` is `4e527f05…` after PR #412 (release authority: FD-059 adopted — Internal.36 signed successor packaged the #399–#411 delta; FD-058 campaign sequencing resolved to one combined campaign on the installed Internal.36 candidate) on top of `7052db9…` (PR #411 behavioral UI-evidence infrastructure + AI proposal-card corrections + agents-surface AAA subtraction), #409 (Phase 4 closure authority green — 8 unclassified Prisma models classified, closure test CI-attached), #408 (#303 disposition: phase4 triage = live VEX disposition authority + frontier reconcile), #406 (FRC-3 Required capability/journey ledger adoption), #405 (P3 AI ledger micro-repairs), #403/#402/#400 and the #399–#410 docs reconcile line; re-resolve live before acting
> **Current signed release:** Internal.36 / `1.0.0-internal.36` / MSI `1.0.0.36` / FD-059 (published 2026-09-08; tag `sahelflow-v1.0.0-internal.36-4e527f0549674789b4f679ae7c2368d2520ccb44`; MSI digest `sha256:5d5b03e284327dd2bc9fb4be674719bba8022506a46a7d3518236dc2700ab243`; signed-build run 34281216710 success 36/36; observer runs 34281232614 + 34281432828 success; certified product head `7052db9e…` tree `1214fe83…` with CI 34271651655, Phase 5 34271651439, Phase 6-7 34271651432 green at that exact head; the ready-battery Phase 5 transient at the release-PR head 43af2298 is recorded on PR #412 — failed-jobs-only re-run green)
> **Latest Founder-installed checkpoint:** Internal.34 / FD-057 (installed in place 2026-09-05; the updater channel now serves Internal.36 per the FD-059 adopted sequencing (b): the Founder skips the interim Internal.35 install and runs the FD-058 campaign rows once on the installed Internal.36 candidate — F-05 residual, F-09..F-13, retained FD-050 rows, D3 waves, applicable #316/#317 native rows, retained #306 rows with logout LAST; rows convert only on that installed observation. Internal.35 (`f45e6e1…`, FD-058) was never Founder-installed and remains retained publication evidence)
