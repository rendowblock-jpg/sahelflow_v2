...
> **Live protected main:** resolve from GitHub before every action; best-known local `origin/main` is `c50f297…` after PR #406 (FRC-3 Required capability/journey ledger adoption) on top of #405 (P3 AI-ledger micro-repairs: F-2/F-3 source truth + AI-17/AI-23 row conversions) and docs-only #404 (the #401–#403 delta reconcile); at the #404 reconciliation it was `418d665…` after #403 (trilingual phone/license/shop-lifecycle server-error rules on top of #402/#401/#400/#399/#398), at the #401 reconciliation it was `41f7e149…` after #400, and at the #399 reconciliation it was `f45e6e1…` after the Internal.35 release-authority PR #398 squash (FD-058; on top of #397 `d83bd8e…` and #396 `dcd82f8…`)
