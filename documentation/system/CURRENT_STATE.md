...
> **Live protected main:** resolve from GitHub before every action; at this reconciliation protected `main` is `f45e6e1…` after the Internal.35 release-authority PR #398 squash (FD-058; on top of the F-13 notifications PR #397 squash `d83bd8e…` and the Internal.34 installed-campaign AI-line PR #396 squash `dcd82f8…`); this docs-only PR re-anchors the handover
