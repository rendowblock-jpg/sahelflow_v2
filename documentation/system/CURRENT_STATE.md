...
> **Live protected main:** resolve from GitHub before every action; at this reconciliation protected `main` is `9dc8e74…` after the INB-27 split PR #392 squash (on top of the PR #391 F-04..F-08 repair line squash `1847396…`); this docs-only PR re-anchors the handover
...
> **Latest Founder-installed checkpoint:** Internal.33 / FD-056 (installed in place 2026-09-03; its installed campaign reported five findings F-04..F-08 — all repaired at source and merged to protected `main` via PR #391, converting only on the next installed observation)
