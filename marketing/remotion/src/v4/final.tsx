    ...
    <AbsoluteFill style={{opacity, pointerEvents: 'none', zIndex: 70}}>
      ...
      <div
        style={{
          ...
          left: 0,
          right: 0,
          top: vertical ? 245 : 250,
          height: 150,
          background: 'linear-gradient(to bottom,#030504 0%,rgba(3,5,4,.90) 36%,transparent 100%)',
        }}
      />
      <div
        style={{
...
export const V4Hero48: React.FC = () => (
  <AbsoluteFill>
    <BaseHero48 />
    <Sequence from={58} durationInFrames={48}><EditorialBridge duration={48} /></Sequence>
...
export const V4Social20: React.FC = () => (
  <AbsoluteFill>
    <BaseSocial20 />
    <Sequence from={27} durationInFrames={45}><EditorialBridge duration={45} /></Sequence>
...
export const V4Vertical12: React.FC = () => (
  <AbsoluteFill>
    <BaseVertical12 />
    <Sequence from={18} durationInFrames={48}><EditorialBridge duration={48} vertical /></Sequence>
...
export const V4Demo75: React.FC = () => (
  <AbsoluteFill>
    <BaseDemo75 />
    <Sequence from={70} durationInFrames={55}><EditorialBridge duration={55} /></Sequence>
